...
namespace SIL.Transcelerator
{
	...
	public class PhraseTranslationHelperTests : PhraseTranslationTestBase
	{
		...
		/// ------------------------------------------------------------------------------------
		/// <summary>
		/// Tests getting category names when the categories are untranslated but the localizer
		/// is set and can provide a localized category name.
		/// </summary>
		/// ------------------------------------------------------------------------------------
		[Test]
		...
		/// ------------------------------------------------------------------------------------
		/// <summary>
		/// Tests getting category names when the categories are translated and the localizer is
		/// also set.
		/// </summary>
		/// ------------------------------------------------------------------------------------
		[Test]
		public void GetCategoryName_TranslatedAndLocalized_GetsVernacularNames()
		{
			var dataLoc = MockRepository.GenerateStub<ILocalizationsProvider>();
			dataLoc.Stub(l => l.Locale).Return("fr");
			dataLoc.Stub(l => l.TryGetLocalizedString(Arg<UIDataString>.Matches(
