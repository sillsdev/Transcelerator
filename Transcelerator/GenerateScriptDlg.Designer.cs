...
namespace SIL.Transcelerator
{
	partial class GenerateScriptDlg
	{
		...
		private void InitializeComponent()
		{
			...
			this.m_chkSourceQuestions = new System.Windows.Forms.CheckBox();
			...
			this.groupBox3.Controls.Add(this.m_chkSourceQuestions);
			...
			// 
			// m_chkSourceQuestions
			// 
			resources.ApplyResources(this.m_chkSourceQuestions, "m_chkSourceQuestions");
			this.m_chkSourceQuestions.Checked = true;
			this.m_chkSourceQuestions.CheckState = System.Windows.Forms.CheckState.Checked;
			this.m_chkSourceQuestions.Name = "m_chkSourceQuestions";
			this.m_chkSourceQuestions.UseVisualStyleBackColor = true;
			this.m_chkSourceQuestions.CheckedChanged += new System.EventHandler(this.IncludeOptionCheckedChanged);
			// 
		...
		internal System.Windows.Forms.CheckBox m_chkSourceQuestions;
