...
namespace SIL.Utils
{
	...
	public class StringUtilsTest
	{
		...
		/// a single underscore (which is a legal - albeit not very nice) filename.
		/// </summary>
		/// ------------------------------------------------------------------------------------
		[TestCase(".")]
		[TestCase(". ")]
		...
		[TestCase("\u00A0")]
		[TestCase("\u00A0.")]
		public void FilterForFileName_StringContainsNothingButPeriodsAndOrSpaces_Throws(string orig)
		{
